...
public class TestDeductionFitCluesToGaps {
   ...
   public void testHardProblem0() {
      testGenericDeduction(Cases.HARD, 0);
   }

   @Test
   public void testHardProblem1() {
      testGenericDeduction(Cases.HARD, 1);
   }

   @Test
   public void testHardProblem2() {
      testGenericDeduction(Cases.HARD, 2);
   }

   @Test
   public void testHardProblem3() {
      testGenericDeduction(Cases.HARD, 3);
   }

   @Test
   public void testHardProblem4() {
      testGenericDeduction(Cases.HARD, 4);
   }

   @Test
   public void testHardProblem5() {
      testGenericDeduction(Cases.HARD, 5);
   }

   @Test
   public void testHardProblem6() {
      testGenericDeduction(Cases.HARD, 6);
   }
